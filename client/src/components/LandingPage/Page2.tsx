...
const Page2 = () => {
  return (
    <div  className="h-[300vh] relative w-full">
        ...
        <div className="absolute cursor-pointer duration-200 top-[25%] sm:top-[18%] z-[9999] w-fit flex flex-col justify-center items-center right-[5%] text-[3rem] sm:text-[4rem] font-bold bg-gradient-to-t from-green-800 via-green-300 to-green-100 bg-clip-text text-transparent font-sans">
          InstantSolve
        </div>
        ...
        <div className="absolute cursor-pointer duration-200 top-[65%] sm:top-[58%] z-[9999] w-fit flex flex-col justify-center items-center right-[5%] text-[3rem] sm:text-[4rem] font-bold bg-gradient-to-t from-green-800 via-green-300 to-green-100 bg-clip-text text-transparent font-sans">
          RapidDebug
        </div>
