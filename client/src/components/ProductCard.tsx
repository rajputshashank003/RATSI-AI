        ...
        <div className="relative h-full w-full">
            ...
            <div onClick={() => navigate(link)} 
                ...
                {`
                    ...
                    rounded-md h-50 sm:h-[40%] border border-green-400 text-4xl
            ...
            >
                ...
                <div className="relative mt-3 bg-green-300 h-[0.5px] w-full"></div>
                <div className="relative mt-2 sm:mt-3 bg-green-300 h-[0.5px] w-full"></div>
